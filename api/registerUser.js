...
exports.registerUser = async ({ OrgMSP, userId }) => {
    ...
    // Empty affiliation inherits the registrar's (root). The default fabric-ca config
    // has no org3.department1, so a per-org affiliation fails for Org3.
    await registerAndEnrollUser(caClient, wallet, OrgMSP, userId, '');
